...
class FrequencyCalculator:
    ...
    def calculate_wrhpair(self):
        """
        Calculates the weights for activities based on righ-handed activity pair frequency estimator.

        Returns:
        - activities_weights: Dict[str, float] - Dictionary with activity and its corresponding weight
        """
        activities_weights = {}
...
class ActivityPairRHWeightEstimator:
    def __init__(self):
        """
        Initializes the ActivityPairRHWeightEstimator object.
    ...
    def estimate_weights_apply(self, log: EventLog, pn: PetriNet):
        """
        Estimates transition weights based on righ-handed activity pair frequency estimator.
