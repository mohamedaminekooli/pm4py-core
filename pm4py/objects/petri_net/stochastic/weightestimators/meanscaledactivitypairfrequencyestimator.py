...
def discover_stochastic_petrinet_mean_scaled_activity_pair_frequency_weight_estimator(log: Union[EventLog, pd.DataFrame, EventStream], 
...
spn = discover_stochastic_petrinet_mean_scaled_activity_pair_frequency_weight_estimator(log, net)
